...
class _$_MarvelComic with DiagnosticableTreeMixin implements _MarvelComic {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'MarvelComic'))
      ..add(DiagnosticsProperty('id', id))
      ..add(DiagnosticsProperty('digitalId', digitalId))
